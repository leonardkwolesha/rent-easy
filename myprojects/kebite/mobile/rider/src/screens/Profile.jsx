  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.body}>
        <Row icon="bicycle-outline"   label="Role"   value="Rider" />
        <Row icon="call-outline"      label="Phone"  value={user?.phone ? formatPhone(user.phone) : '—'} />
        <Row icon="wallet-outline"    label="Wallet" value="Connected to M-Pesa" />
...
const styles = StyleSheet.create({
  ...
  phone:      { color: '#fff', opacity: 0.9, marginTop: 2 },
  body:       { padding: 16 },
